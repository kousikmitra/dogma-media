...
.bg-image {
  background-image: url('./images/login-page-photo.jpeg');
            ...
            <div class="col-md-9 col-lg-8 mx-auto">
              ...
              <form name='login_form' method="post" action="./login_script.php">
                ...
                <div class="text-center my-2">
                  <a class="display4" href="#">Forgot password?</a></div>
                  <div class="text-center">
                  <a class="small btn btn-lg btn-outline-primary btn-block btn-login text-uppercase font-weight-bold mb-2" href="./signup.php">Sign Up Here!</a></div>
              </form>
            </div>
          </div>
        </div>
