      ...
      <div class="col-lg-12 col-xl-9 mx-auto">
        <div class="card card-signin flex-row mt-5">
          ...
          <div class="card-body">
            ...
            <form class="form-signin" name="register" method="post" action="./signup_script.php">
            <div class="form-label-group">
              ...
              <button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit" name="sign_up">Register</button>
